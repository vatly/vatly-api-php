 ...
 *
 * Mirrors the wire shape returned by {@see \Vatly\API\Webhooks\Webhook::parse()}
 * — see {@see \Vatly\API\Webhooks\WebhookPayload}. The `object` field is
 * converted from the upstream stdClass to a deep array so consumers can use
 * array access (`$webhook->object['customerId']`) without juggling
