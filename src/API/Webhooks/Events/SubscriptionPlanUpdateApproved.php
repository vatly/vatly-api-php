...
/**
 * Event representing a submitted subscription plan update being **approved** and applied. The live
 * plan now reflects the new values and any pending update is cleared.
 *
 ...
 * @immutable
 */
class SubscriptionPlanUpdateApproved
{
    public const VATLY_EVENT_NAME = WebhookEventName::SUBSCRIPTION_PLAN_UPDATE_APPROVED;
