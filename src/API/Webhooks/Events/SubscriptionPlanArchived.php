...
/**
 * Event representing a subscription plan being **archived** — closed to new business. Existing
 * subscribers keep billing unchanged; `archivedAt` is now non-null.
 *
 ...
 * @immutable
 */
class SubscriptionPlanArchived
{
    public const VATLY_EVENT_NAME = WebhookEventName::SUBSCRIPTION_PLAN_ARCHIVED;
