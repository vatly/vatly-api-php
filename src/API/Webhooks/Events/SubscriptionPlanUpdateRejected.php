...
/**
 * Event representing a submitted subscription plan update being **rejected**. The live plan is
 * unchanged and the pending update is cleared.
 *
 ...
 * @immutable
 */
class SubscriptionPlanUpdateRejected
{
    public const VATLY_EVENT_NAME = WebhookEventName::SUBSCRIPTION_PLAN_UPDATE_REJECTED;
