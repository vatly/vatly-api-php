...
/**
 * Event representing a submitted one-off product update being **rejected**. The live product is
 ...
 * @immutable
 */
class OneOffProductUpdateRejected
{
    public const VATLY_EVENT_NAME = WebhookEventName::ONE_OFF_PRODUCT_UPDATE_REJECTED;
